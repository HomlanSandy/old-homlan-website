<?php /* Smarty version 2.6.26, created on 2012-07-19 20:53:54
         compiled from commendmodulelist.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'math', 'commendmodulelist.htm', 68, false),)), $this); ?>
...
<!--
	...
	├======================================│ 宣 告 │========================================┤
	├======================================└───────┘========================================┤
	│	程式用途	│	commendmodulelist.htm		後台推薦模組管理 的 htm檔
	│	開發者		│	玉玲
	│	版本		│	v1.0.0.0080601
	├=======================================================================================┤
	│	1.	v1.0.1.0080601	2010/08/06	廷俊	輸入查詢條件後 與 下拉式選擇頁碼，都必須selected查詢條件的值
	│	2.	v2.0.1.0112401	2010/11/24	娜娜	加入資訊狀態欄位
	└=======================================================================================┘
-->
<body>
...
<form name="seachvotefrm" method="post" action="commendmodulelist.php?act=list">
<div id="search_block">
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="left">
...
?>
    <tr>          
	   ...
	   <td height="25" valign="middle" align="left" class="table_td_02"><?php echo $this->_tpl_vars['umCmd'][$this->_sections['i']['index']]['commend_title']; ?>
</td>
	   <td height="25" valign="middle" align="center" class="table_td_02"><?php echo $this->_tpl_vars['umCmd'][$this->_sections['i']['index']]['commend_startdate']; ?>
</td>
	   <td height="25" valign="middle" align="center" class="table_td_02"><?php echo $this->_tpl_vars['umCmd'][$this->_sections['i']['index']]['commend_enddate']; ?>
</td>
	   ...
	   <td height="25" valign="middle" align="center" class="table_td_02"><a href="<?php echo $this->_tpl_vars['umCmd'][$this->_sections['i']['index']]['commend_url']; ?>
"><?php echo $this->_tpl_vars['ModuleEdit']; ?>
</a>&nbsp;|&nbsp;<a href="<?php echo $this->_tpl_vars['umCmd'][$this->_sections['i']['index']]['delcommend_url']; ?>
