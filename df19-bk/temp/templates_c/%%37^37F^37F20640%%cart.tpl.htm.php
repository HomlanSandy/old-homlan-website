<?php /* Smarty version 2.6.26, created on 2017-04-11 17:34:01
         compiled from cart.tpl.htm */ ?>
...
<!--
	...
	├======================================│ 宣 告 │========================================┤
	├======================================└───────┘========================================┤
	│	程式用途	│	cart.tpl.htm		前台購物車 的 HTML樣板頁面
	│	開發者		│	廷俊
	│	版本		│	v03.00.02.1040801
	├=======================================================================================┤
	│	1.	v03.00.02.1040801	2011/04/28	廷俊	若非會員使用購物車，修正轉址至會員登入頁，而非引入會員登入模組
...
?>
			<tr><td valign="top" style="width:100%;"><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
;">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		<td valign="top">
			<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/cart_list.tpl.htm", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
		</td>
