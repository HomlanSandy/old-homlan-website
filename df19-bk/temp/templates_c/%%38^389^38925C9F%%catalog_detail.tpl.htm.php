<?php /* Smarty version 2.6.26, created on 2012-07-09 16:11:55
         compiled from catalog_detail.tpl.htm */ ?>
...
<!-- /*
	...
	├======================================│ 宣 告 │========================================┤
	├======================================└───────┘========================================┤
	│	程式用途	│	catalog_detail.tpl.htm		前台明細 的HTML樣板頁面
	│	開發者		│	廷俊
	│	版本		│	v03.00.03.1050301
	├=======================================================================================┤
	│	1.	v03.00.03.1050301	2011/05/06	廷俊	驗證是否設定並啟用明細頁面的流量分析，有則載入明細頁面的 <head> 區段
...
;">
	...
	<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
	  <tr>
		<td class="header_userlink"><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/catalog_content.tpl.htm", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?></td>
		  </tr>
