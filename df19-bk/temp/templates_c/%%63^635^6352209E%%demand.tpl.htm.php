...
<!-- /*
	...
	├======================================│ 宣 告 │========================================┤
	├======================================└───────┘========================================┤
	│	程式用途	│	demand.tpl.htm		前台需求單 的HTML處理頁面
	│	開發者		│	廷俊
	│	版本		│	v1.0.1.0091301
	├=======================================================================================┤
	│	1.	v1.0.1.0091301	2010/09/13	廷俊	建立前台需求單
	│	2.	v2.0.4.0120701	2010/12/07 	廷俊	a.需求單設定開放可不限會員
	│											b.若需求單限會員，並驗證是否登入會員，否則導入會人登入頁面
	│	3.	v03.00.02.1040801	2011/04/28	廷俊	驗證填寫需求單請先登入會員，修正轉址至會員登入頁，而非引入會員登入模組
...
<!--
	...
	-----------------------------------------
-->		
		<?php if ($this->_tpl_vars['demand_mode'] != 0): ?>
			<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/demand_list.tpl.htm", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
		<?php else: ?>
			<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/demand_car.tpl.htm", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
		<?php endif; ?>
