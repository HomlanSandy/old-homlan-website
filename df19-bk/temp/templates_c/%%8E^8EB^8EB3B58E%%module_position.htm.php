<?php /* Smarty version 2.6.26, created on 2012-07-09 15:59:07
         compiled from module_position.htm */ ?>
...
<div id="use_title">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><?php echo $this->_tpl_vars['PageTitle_default']; ?>
</td>
    </tr>
  </table>
</div>
...
" onsubmit="return chkpost();">
    ...
    <tr>
      ...
      <td width="95%" height="40" align="left" valign="middle"><?php echo $this->_tpl_vars['select_page1']; ?>
<br>
        <select name="jumpMenu" id="jumpMenu" onChange="MM_jumpMenu('self',this,0)">
        <?php unset($this->_sections['p']);
$this->_sections['p']['name'] = 'p';
$this->_sections['p']['loop'] = is_array($_loop=$this->_tpl_vars['page']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?> 
        <?php if ($this->_tpl_vars['page'][$this->_sections['p']['index']]['page_id'] == $_GET['page_id']): ?>
        <option value="module_position.php?page_id=<?php echo $this->_tpl_vars['page'][$this->_sections['p']['index']]['page_id']; ?>
" selected><?php echo $this->_tpl_vars['page'][$this->_sections['p']['index']]['page_na']; ?>
</option>
        <?php else: ?>
        <option value="module_position.php?page_id=<?php echo $this->_tpl_vars['page'][$this->_sections['p']['index']]['page_id']; ?>
"><?php echo $this->_tpl_vars['page'][$this->_sections['p']['index']]['page_na']; ?>
</option>
        <?php endif; ?>
        <?php endfor; endif; ?>
      </select>
...
" style="width:140px;">&nbsp;<INPUT TYPE="button" value="<?php echo $this->_tpl_vars['Btn_reset']; ?>
" onClick="location.href='module_position.php?default=y&page_id=<?php echo $_GET['page_id']; ?>
'">
</td>
</tr>
</table>
