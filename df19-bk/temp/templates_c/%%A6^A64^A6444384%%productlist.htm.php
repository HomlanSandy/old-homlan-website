<?php /* Smarty version 2.6.26, created on 2012-07-09 16:11:10
         compiled from productlist.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'math', 'productlist.htm', 78, false),)), $this); ?>
...
<!--
	...
	├======================================│ 宣 告 │========================================┤
	├======================================└───────┘========================================┤
	│	程式用途	│	productlist.htm		商品明細列表 的 htm檔
	│	開發者		│	廷俊
	│	版本		│	v1.0.0.0073001
	├=======================================================================================┤
	│	1.	v1.0.1.0073001	2010/07/30	廷俊	刪除商品明細成功提示訊息
	│	2.	v1.0.1.0080501	2010/08/05	廷俊	商品明細列表：顯示商品編號、定價、售價、庫存量
	│	3.	v1.0.1.0080601	2010/08/06	廷俊	輸入查詢條件後 與 下拉式選擇頁碼，都必須selected查詢條件的值
	│	4.	v2.0.0.0111101	2010/11/11	娜娜	將資訊狀態加入列表搜尋條件
	└=======================================================================================┘
-->
<body>
  <div id="use_title">
...
<!--
	...
	--------------------------------------------------------------
	商品明細列表：顯示商品編號、定價、售價、庫存量
	-------------------------------------------------------------- 
-->
<?php echo $this->_tpl_vars['Message']; ?>

<form name="seachfrm" method="post" action="productlist.php?act=list&qlist=1">
<div id="search_block">
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
...
<div id="show_table4" class="main_link">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>     
	  ...
	  <!-- <td width="60px" height="25" align="center" valign="middle" class="table_td_01"><?php echo $this->_tpl_vars['ProductId']; ?>
</td> -->
	  <td width="60px" height="25" align="center" valign="middle" class="table_td_01"><?php echo $this->_tpl_vars['PriceFix']; ?>
</td>
	  <td width="60px" height="25" align="center" valign="middle" class="table_td_01"><?php echo $this->_tpl_vars['PriceSale']; ?>
</td>
	  <td width="60px" height="25" align="center" valign="middle" class="table_td_01"><?php echo $this->_tpl_vars['Stocks']; ?>
</td>
...
?>
    <tr>     
	  ...
	  <td height="25" align="left" valign="middle" class="table_td_02"><?php echo $this->_tpl_vars['umInfos'][$this->_sections['i']['index']]['infos_na']; ?>
	   ...
	   <!-- <td height="25" align="left" valign="middle" class="table_td_02"><?php echo $this->_tpl_vars['umInfos'][$this->_sections['i']['index']]['product_id']; ?>
</td> -->
	  <td height="25" align="right" valign="middle" class="table_td_02"><?php echo $this->_tpl_vars['umInfos'][$this->_sections['i']['index']]['price_fix']; ?>
</td>
	  <td height="25" align="right" valign="middle" class="table_td_02"><?php echo $this->_tpl_vars['umInfos'][$this->_sections['i']['index']]['price_sale']; ?>
</td>
	  <td height="25" align="right" valign="middle" class="table_td_02"><?php echo $this->_tpl_vars['umInfos'][$this->_sections['i']['index']]['stock']; ?>
</td>
...
<!--
	...
	---------------------------------------------------- 	
	2010-11-11 edit by 娜娜
	----------------------------------------------------
	輸入查詢條件加入資訊狀態，加入selected值
	---------------------------------------------------- 		
