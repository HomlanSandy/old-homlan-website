...
<!-- 載入流量分析 -->
<?php echo $this->_tpl_vars['flow_analysis']; ?>
...
-->
		<!-- 非特定會員，無瀏覽權限 -->
		<?php if ($this->_tpl_vars['isReadGroup'] == 2): ?>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			   <tr>
					<td align="center" style="color:red;font-size:16pt;">
						<?php echo $this->_tpl_vars['msg_users_group']; ?>

					</td>
				</tr>
			</table>
		<?php elseif ($this->_tpl_vars['isReadGroup'] == 1): ?>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td valign="top" class="header_userlink">
						<!--分類連結-->
						<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/header_userlink.tpl.htm", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
					</td>
				...
				<tr>
					<td valign="top">
						<!--簡單說明-->
						<?php echo $this->_tpl_vars['catelog_simple_text']; ?>
				...
				<tr>
					<td valign="top">
						<!--詳細說明-->
						<?php echo $this->_tpl_vars['catelog_detail_text']; ?>

					</td>
				</tr> 
				<?php if ($this->_tpl_vars['cats_next_num'] > 0): ?>
				<tr>
					<!--下級分類列表-->
					<td valign="top">
						<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/catalog_next.tpl.htm", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
					</td>
				...
				<tr>
					<td valign="top">
						<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/catalog_list.tpl.htm", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
					</td>
...
unset($_smarty_tpl_vars);
 ?>
	...
	<!-- 頁身 右方 區域位置設定 -->
		<td id="right" valign="top" style="width:<?php echo $this->_tpl_vars['right']; ?>
;">
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
