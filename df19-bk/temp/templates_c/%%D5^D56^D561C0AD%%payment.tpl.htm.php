...
<!-- /*
	...
	├======================================│ 宣 告 │========================================┤
	├======================================└───────┘========================================┤
	│	程式用途	│	payment.tpl.htm		前台付款方式 的HTML處理頁面
	│	開發者		│	廷俊
	│	版本		│	v1.0.1.0090901
	├=======================================================================================┤
	│	1.	v1.0.1.0090901	2010/09/09	廷俊	建立前台付款方式
	│	2.	v03.00.02.1040801	2011/04/28	廷俊	若非會員使用付款方式，修正轉址至會員登入頁，而非引入會員登入模組
	│	3.  v03.00.10.1062001	2011-06-22	玉玲	新增判斷螢幕解析度大小函式 container_js。
	└=======================================================================================┘
*/-->
<body>
...
;">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	 <?php if ($this->_tpl_vars['payment_mod_chk'] == '0'): ?>
	 <tr>
		<td valign="top">
			<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/payment_login.tpl.htm", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
		</td>
	...
	<?php endif; ?>
	<?php if ($this->_tpl_vars['payment_mod_chk'] == '1'): ?>
	  <tr>
		<td valign="top">
			<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/payment_list.tpl.htm", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
		</td>
