<?php /* Smarty version 2.6.26, created on 2012-07-30 09:55:59
         compiled from frmlist.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'math', 'frmlist.htm', 79, false),)), $this); ?>
...
<div id="show_table4" class="main_link">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>           
	  ...
	  <td width="" height="25" align="center" valign="middle" class="table_td_01"><?php echo $this->_tpl_vars['List_cat']; ?>
</td>
	  <td width="90px" height="25" align="center" valign="middle" class="table_td_01"><?php echo $this->_tpl_vars['InfoState']; ?>
</td>
      <td width="300px" height="25" align="center" valign="middle" class="table_td_01"><?php echo $this->_tpl_vars['listoperator']; ?>
</td>
    </tr>
...
&nbsp;</td> 
	   <td height="25" valign="middle" align="left" class="table_td_02"><?php echo $this->_tpl_vars['umList'][$this->_sections['i']['index']]['list_na']; ?>
</td>
	   ...
	   <td height="25" valign="middle" align="center" class="table_td_02"><a href="#" onclick="window.open('<?php echo $this->_tpl_vars['umList'][$this->_sections['i']['index']]['list_preview_clean']; ?>
','','')"><?php echo $this->_tpl_vars['Btn_Preview_clean']; ?>
</a>&nbsp;|&nbsp;<a href="#" onclick="window.open('<?php echo $this->_tpl_vars['umList'][$this->_sections['i']['index']]['list_preview']; ?>
','','')"><?php echo $this->_tpl_vars['Btn_Preview']; ?>
</a>&nbsp;|&nbsp;<a href="<?php echo $this->_tpl_vars['umList'][$this->_sections['i']['index']]['list_edit']; ?>
"><?php echo $this->_tpl_vars['Btn_Edit']; ?>
</a>&nbsp;|&nbsp;<a href="<?php echo $this->_tpl_vars['umList'][$this->_sections['i']['index']]['list_delete']; ?>
